...
export default function Category() {
  ...
  return (
    <Layout title={`Yoruba Community Online : ${id}`}>
      <div class="container">
        ...
        <div class="tt-topic-list">
          ...
          <div class="tt-item tt-itemselect">
            <div class="tt-col-avatar">
              <span class="tt-icon">
                <AiOutlinePaperClip style={{ fontSize: "2.5em" }} />
              </span>
            </div>
            <div class="tt-col-description">
              <h6 class="tt-title">
                <Link
                  href={{
                    pathname: "/post",
                    query: { postid: "hallow-night" },
                  }}
                >
                  <a>Halloween Costume Contest 2018</a>
                </Link>
              </h6>
              ...
              <div class="row align-items-center no-gutters">
                <div class="col-11">
                  <ul class="tt-list-badge">
                    ...
                    <li>
                      <a href="#">
                        <span class="tt-badge">contests</span>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <span class="tt-badge">authors</span>
                      </a>
                    </li>
                  </ul>
                </div>
